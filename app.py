...
def main():
    ...
    int_select = st.sidebar.radio(label='Please select confidence interval to be displayed', options=[.80, .85, .90, .95, .99], help=('Upper and lower interval to be displayed'), index=4)
